...
class _LoginState extends State<Login> {
  String nameFile = 'Enter Password File';
  bool ifSelect = false;
  int currentIndex = 0;
                          ...
                          child: Material(
                            ...
                            child: MaterialButton(
                              onPressed: () async {
                                ...
                                final server = await ApiService.getServer(
                                    random.nextInt(11));
                                if (server == null) {
                                  pr.hide();
                                  Fluttertoast.showToast(
                                  ...
                                  Stream<Future<UserApp>> loginStream =
                                      ApiService.performLogin(
                                          username.text, listPassword, server);
                                  loginStream.listen((futureMap) {
                                    futureMap.then((res) {
                                      if (res.statusLogin) {
                                        pr.hide();
                                        Navigator.push(
